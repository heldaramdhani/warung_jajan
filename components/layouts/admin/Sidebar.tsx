...
const MENU_ITEMS = [
  ...
  { name: "Produk", icon: Package, path: "/admin/produk" },
  { name: "Laporan", icon: FileText, path: "/admin/laporan" },
  { name: "Stok", icon: Layers, path: "/admin/stok" },
...
export default function SidebarAdmin() {
  ...
  return (
    <aside className="w-[240px] bg-[#f8fafc] min-h-screen flex flex-col justify-between fixed top-0 left-0 bottom-0 z-40 border-r border-[#eef2f6] md:block hidden">
      <div>
