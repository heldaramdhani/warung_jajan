...
export default function TransactionTable() {
  return (
    <div className="bg-white p-5 rounded-xl shadow-sm border border-slate-100 w-full mt-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-start mb-5 w-full">
        <div>
          <h3 className="text-[14px] font-bold text-slate-800">
            Transaksi Terbaru
          </h3>
          <p className="text-[11px] text-slate-400 mt-0.5">
            Mengambil data terbaru dari sistem transaksi
          </p>
        </div>
        <Link
          href="/admin/laporan"
          className="text-[12px] font-bold text-[#00A86B] hover:text-[#008f5a]"
        >
          Lihat Semua
        </Link>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-slate-100">
              <th className="pb-3 text-[12px] font-bold text-slate-400 font-sans tracking-wide">
                ID Referensi
              </th>
              <th className="pb-3 text-[12px] font-bold text-slate-400 font-sans tracking-wide">
                Tanggal & Waktu
